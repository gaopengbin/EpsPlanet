(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    exports.PlanetIdentifyComponent.ɵcmp = i0.ɵɵdefineComponent({ type: exports.PlanetIdentifyComponent, selectors: [["epsgis-planet-identify"]], features: [i0.ɵɵInheritDefinitionFeature], decls: 15, vars: 12, consts: [["title", "\u8BC6\u522B", 1, "jimu-widget-onscreen-icon"], ["nz-icon", "", 3, "nzIconfont", "click"], [1, "dialog", 3, "hidden", "ngStyle"], [1, "panel"], ["nz-icon", "", "nzType", "close", "nzTheme", "outline", 2, "float", "right", 3, "click"], [3, "nzData", "nzFrontPagination", "nzShowPagination", "nzTitle"], ["basicTable", ""], [4, "ngFor", "ngForOf"], ["nz-button", "", 3, "click"], ["nz-icon", "", "nzType", "zoom-in", "nzTheme", "outline"], [1, "arrow"]], template: function PlanetIdentifyComponent_Template(rf, ctx) {
            if (rf & 1) {
    ...
    exports.PlanetLocationComponent.ɵcmp = i0.ɵɵdefineComponent({ type: exports.PlanetLocationComponent, selectors: [["epsgis-planet-location"]], features: [i0.ɵɵInheritDefinitionFeature], decls: 12, vars: 13, consts: [[3, "ngModel", "nzMin", "nzMax", "nzStep", "nzPlaceHolder", "ngModelChange"], [4, "ngIf"], ["nz-button", "", "nzType", "primary", 3, "click"], [3, "ngModel", "nzStep", "nzPlaceHolder", "ngModelChange"]], template: function PlanetLocationComponent_Template(rf, ctx) {
        ...
        }, directives: [i6.NzInputNumberComponent, i1$3.NgControlStatus, i1$3.NgModel, i2$2.NgIf, i6$1.NzButtonComponent, i7.NzWaveDirective, i2$1.ɵNzTransitionPatchDirective], styles: ["div[_ngcontent-%COMP%]{margin-bottom:5px;text-align:center}nz-input-number[_ngcontent-%COMP%]{width:80%}"] });
    ...
    function PlanetModeSwitchComponent_ng_template_5_Template(rf, ctx) {
        if (rf & 1) {
            ...
            i0.ɵɵlistener("click", function PlanetModeSwitchComponent_ng_template_5_Template_div_click_1_listener() { i0.ɵɵrestoreView(_r6_1); var ctx_r5 = i0.ɵɵnextContext(); return ctx_r5.changeViewMode("3d"); });
            i0.ɵɵnamespaceSVG();
            ...
            i0.ɵɵlistener("click", function PlanetModeSwitchComponent_ng_template_5_Template_div_click_4_listener() { i0.ɵɵrestoreView(_r6_1); var ctx_r7 = i0.ɵɵnextContext(); return ctx_r7.changeViewMode("2d"); });
            i0.ɵɵnamespaceSVG();
            i0.ɵɵelementStart(5, "svg", 10);
            i0.ɵɵelement(6, "path", 6);
            i0.ɵɵelementEnd();
            i0.ɵɵelementEnd();
            i0.ɵɵnamespaceHTML();
            i0.ɵɵelementStart(7, "div", 9);
            i0.ɵɵlistener("click", function PlanetModeSwitchComponent_ng_template_5_Template_div_click_7_listener() { i0.ɵɵrestoreView(_r6_1); var ctx_r8 = i0.ɵɵnextContext(); return ctx_r8.changeViewMode("columbus"); });
            i0.ɵɵnamespaceSVG();
    ...
    exports.PlanetZoomComponent.ɵcmp = i0.ɵɵdefineComponent({ type: exports.PlanetZoomComponent, selectors: [["epsgis-planet-zoom"]], features: [i0.ɵɵInheritDefinitionFeature], decls: 4, vars: 0, consts: [["title", "\u653E\u5927", 1, "jimu-widget-onscreen-icon", "zoomIn", 3, "click"], ["nz-icon", "", "nzType", "plus", "nzTheme", "outline"], ["title", "\u7F29\u5C0F", 1, "jimu-widget-onscreen-icon", "zoomOut", 3, "click"], ["nz-icon", "", "nzType", "minus", "nzTheme", "outline"]], template: function PlanetZoomComponent_Template(rf, ctx) {
            if (rf & 1) {
                i0.ɵɵelementStart(0, "div", 0);
        ...
        }, directives: [i1$1.NzIconDirective, i2$1.ɵNzTransitionPatchDirective], styles: [".jimu-widget-onscreen-icon[_ngcontent-%COMP%]{margin-top:20px}"] });
    ...
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(exports.PlanetEqueryComponent, [{
                type: i0.Component,
                args: [{
